...
const createTestData = (): readonly Row[] => [
  ...
  { date: '2023-01-03', sales: 200, region: 'East', percent: 0.40, category: 'A' },
  { date: '2023-01-04', sales: 120, region: 'West', percent: 0.30, category: 'C' }
]
...
describe('generateVegaSpec', () => {
  ...
  describe('Line Chart', () => {
    it('should generate valid line chart spec', () => {
      ...
      const lineLayer = spec.layer.find((layer: any) => 
        layer.mark?.type === 'line' || layer.mark === 'line'
      )
  ...
  describe('Area Chart', () => {
    it('should generate valid area chart spec', () => {
      ...
      const areaLayer = spec.layer.find((layer: any) => 
  ...
  describe('Headline Display', () => {
    ...
    it('should handle dark theme for headline', () => {
      ...
      const textLayer = spec.layer.find((layer: any) => 
        layer.mark?.type === 'text' && layer.encoding?.color?.value
      )
