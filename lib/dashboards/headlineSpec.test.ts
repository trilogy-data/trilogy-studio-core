...
import { isImageColumn, HIGHLIGHT_COLOR, getColumnFormat, getVegaFieldType } from './helpers'
...
describe('createHeadlineSpec', (): void => {
  ...
  describe('basic functionality', (): void => {
    it('should create a valid vega-lite spec', (): void => {
      const spec = createHeadlineSpec(mockConfig, mockData, mockColumns, 'light' as Theme, false, mockIntChart)
    ...
    it('should handle empty data', (): void => {
      const spec = createHeadlineSpec(mockConfig, null, mockColumns, 'light' as Theme, false, mockIntChart)
    ...
    it('should handle empty columns', (): void => {
      ...
      const spec = createHeadlineSpec(mockConfig, mockData, emptyColumns, 'light' as Theme, false, mockIntChart)
    ...
    it('should respect hideLegend config', (): void => {
      ...
      const spec = createHeadlineSpec(configWithHiddenLegend, mockData, mockColumns, 'light' as Theme, false, mockIntChart)
  ...
  describe('desktop layout (isMobile: false)', (): void => {
    it('should distribute elements horizontally', (): void => {
      ...
      const layersWithDx = spec.layer.filter((layer: any) => layer.mark.dx && typeof layer.mark.dx === 'object')
      expect(layersWithDx.length).toBeGreaterThan(0)

      // Check that dy is fixed (not expression-based) for desktop
      const layersWithFixedDy = spec.layer.filter((layer: any) => typeof layer.mark.dy === 'number' || layer.mark.dy === 0)
    ...
    it('should center single metric horizontally', (): void => {
      ...
      const spec = createHeadlineSpec(mockConfig, mockData, singleColumn, 'light' as Theme, false, mockIntChart)
  ...
  describe('mobile layout (isMobile: true)', (): void => {
    it('should distribute elements vertically', (): void => {
      const spec = createHeadlineSpec(mockConfig, mockData, mockColumns, 'light' as Theme, true, mockIntChart)
    ...
    it('should center single metric vertically', (): void => {
      ...
      const spec = createHeadlineSpec(mockConfig, mockData, singleColumn, 'light' as Theme, true, mockIntChart)

      // Single metric should have centered positioning
      const layersWithDy = spec.layer.filter((layer: any) => layer.mark.dy && typeof layer.mark.dy === 'object')
    ...
    it('should use smaller font sizes for mobile', (): void => {
      const mobileSpec = createHeadlineSpec(mockConfig, mockData, mockColumns, 'light' as Theme, true, mockIntChart)
      const desktopSpec = createHeadlineSpec(mockConfig, mockData, mockColumns, 'light' as Theme, false, mockIntChart)
  ...
  describe('theming', (): void => {
    ...
    it('should apply dark theme colors', (): void => {
      const spec = createHeadlineSpec(mockConfig, mockData, mockColumns, 'dark' as Theme, false, mockIntChart)
  ...
  describe('responsive font scaling', (): void => {
    it('should scale font size based on number of metrics and data rows', (): void => {
      ...
      const smallSpec = createHeadlineSpec(mockConfig, mockData, twoColumns, 'light' as Theme, false, mockIntChart)
      const largeSpec = createHeadlineSpec(mockConfig, multiRowData, mockColumns, 'light' as Theme, false, mockIntChart)
  ...
  describe('image column handling', (): void => {
    it('should handle image columns differently', (): void => {
      ...
      const spec = createHeadlineSpec(mockConfig, imageData, imageColumns, 'light' as Theme, false, mockIntChart)
