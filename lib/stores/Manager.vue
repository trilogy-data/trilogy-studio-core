...
const { setActiveScreen, setActiveEditor, setActiveDashboard, setActiveScreenWithParams } = useScreenNavigation()
...
provide('setActiveScreenWithParams', setActiveScreenWithParams)
