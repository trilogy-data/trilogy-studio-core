...
export const functions = [
  ...
  'current_datetime',
  'current_timestamp',
  "date_add # ex date_add('2020-01-01'::date, month, 1)",
  "date_diff # ex date_diff('2020-01-01'::date, '2020-01-02'::date, day)",
  "date_part # ex date_part('2020-01-01'::date, year)",
  "date_sub # ex date_sub('2020-01-01'::date, day, 1)",
  "date_trunc # ex date_trunc('2020-01-01'::date, month)",
  'date_spine',
  'datetime',
  'day',
  'day_of_week',
