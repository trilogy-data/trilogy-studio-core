...
<template>
  <DashboardBase ref="dashboardBase" :key="name" :name="name" :connection-id="connectionId" :max-width="maxWidth"
    :view-mode="viewMode" :is-mobile="false" @layout-updated="onLayoutUpdated" @dimensions-update="updateItemDimensions"
  ...
  <div class="dashboard-container" v-if="dashboard">
    ...
    <Teleport to="body" v-if="showMarkdownEditor && editingItem">
      <MarkdownEditor :content="getItemData(editingItem.i, dashboard.id).content" @save="dashboardBase?.saveContent"
