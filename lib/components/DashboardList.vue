<template>
      ...
      <div v-if="showDeleteConfirmationState" class="confirmation-overlay" @click.self="cancelDelete">
        <div class="confirmation-dialog">
          ...
          <div class="dialog-actions">
            ...
            <button class="confirm-btn" data-testid="confirm-dashboard-deletion" @click="confirmDelete">
              Delete
            </button>
          </div>
        </div>
  ...
  export default {
    ...
    setup(props: { activeDashboard: string, testTag: string }) {
    ...
    methods: {
      // @ts-ignore
      showDeleteConfirmation(dashboard) {
