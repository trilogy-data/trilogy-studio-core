    ...
    <div v-if="visible" class="creator-container">
        <form @submit.prevent="submitConnectionCreation">
            <div class="form-row">
                ...
                <input data-testid="connection-creator-name" type="text" v-model="connectionDetails.name"
                    id="connection-name" required />
            </div>
            ...
            <div v-if="connectionDetails.type === 'motherduck'" class="form-row">
                ...
                <input type="password" v-model="connectionDetails.options.mdToken" id="md-token"
