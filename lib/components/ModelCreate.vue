        ...
        <div v-if="visible" class="absolute-form">
            <form @submit.prevent="submitModelCreation">
                <div>
                    ...
                    <select v-model="modelDetails.connection" id="model-connection"
                        placeholder="Models must have a connection." required>
                    ...
                    <div v-if="modelDetails.connection === 'new-motherduck'">
                        ...
                        <input type="text" v-model="modelDetails.options.mdToken" id="md-token"
                    ...
                    <div v-if="modelDetails.connection === 'new-bigquery-oauth'">
                        ...
                        <input type="text" v-model="modelDetails.options.projectId" id="project-id"
                            placeholder="Billing Project ID" required />
                    </div>
                    <label for="model-import">Import From Address</label>
                    <input placeholder="Optional. Import github definition." type="text"
                        v-model="modelDetails.importAddress" id="model-import" />
                </div>
        ...
        const submitModelCreation = async () => {
            if (modelDetails.value.name) {
                ...
                if (modelDetails.value.connection.startsWith('new-')) {
                    connectionStore.newConnection(modelDetails.value.name, modelDetails.value.connection.replace('new-', ''), { mdToken: modelDetails.value.options.mdToken, projectId: modelDetails.value.options.projectId, username: modelDetails.value.options.username, password: modelDetails.value.options.password })
                }
                else {
