<template>
  <div class="settings-container">
    ...
    <div class="setting" v-for="(value, key) in settings" :key="key">
      ...
      <input v-if="typeof value === 'boolean'" type="checkbox" :id="key" v-model="settings[key]" @change="updateSetting(key, settings[key])" />
      <input v-else-if="typeof value === 'string'" type="text" :id="key" v-model="settings[key]" @input="updateSetting(key, settings[key])" />
    </div>
    <div class="actions">
