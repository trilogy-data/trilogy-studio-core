<template>
  <div class="vega-lite-chart no-drag" :class="{ 'overflow-hidden': !controlsManager.showingControls.value }"
    ...
    <div class="controls-toggle" :class="{
      ...
      <button v-if="$props.drilldownActive" @click="revertDrilldown" class="control-btn" data-testid="refresh-chart-btn"
    ...
    <div ref="chartContentArea" class="chart-content-area" :class="{
