<template>
    <div>
        ...
        <button class="quick-new-editor-button trilogy-class" @click.stop="openPopup"
            :data-testid="`create-datasource-${table.name}`" title="Create Datasource From Table">
                        ...
                        <div class="left-column">
                            ...
                            <div class="form-section">
                                ...
                                <div class="column-config-container">
                                    <div v-for="column in table.columns" :key="column.name" class="column-config-item">
                                        <div class="column-row">
                                            <div class="column-info">
                                                ...
                                                <label class="checkbox-label">
                                                    ...
                                                    <input type="checkbox" :value="column.name"
                                                        v-model="selectedGrainKeys" @change="updateDatasourcePreview" />
                                            ...
                                            <div class="column-description">
                                                <input type="text"
                                                    ...
                                                    placeholder="Enter description..." class="description-input" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-section">
                                ...
                                <div class="sample-data-container">
                                    ...
                                    <div v-else-if="sampleData && sampleData.data && sampleData.data.length > 0"
                                        class="data-table-wrapper">
                                        <DataTable :results="sampleData.data" :headers="sampleData.headers"
                                            :fitParent="true" />
                        ...
                        <div class="right-column">
                            <div class="form-section">
                                ...
                                <div class="code-preview">
                                    ...
                                    <code-block :content="datasourcePreview" language="preql" />
                                </div>
                            </div>
                        </div>
                    </div>
