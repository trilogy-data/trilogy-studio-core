  ...
  <div class="sidebar-container">
    <div class="sidebar-icons">
      <div class="trilogy-icon">
        <img class="trilogy-icon" @click="selectItem('welcome')" :src="trilogyIcon" title="Trilogy Studio (Alpha)" />
      </div>
    ...
    <div class="sidebar-content">
      ...
      <ConnectionList v-show="active === 'connections'" @connection-key-selected="connectionKeySelected"
        @toggle-mobile-menu="toggleMobileMenu" :activeConnectionKey="activeConnectionKey" />
      ...
      <DashboardList v-show="active === 'dashboard'" @dashboard-key-selected="dashboardKeySelected"
        @save-editors="saveDashboards" :activeDashboardKey="activeDashboardKey"
