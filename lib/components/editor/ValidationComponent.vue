    ...
    <div class="debug-container">
        ...
        <div class="test-details-container">
            ...
            <div class="validation-info">
                <div class="info-item">
                    <strong>Label:</strong> {{ testData.label }}
                </div>
        ...
        <div class="tests-container">
            <div class="section-header">
                ...
                <div class="header-controls">
                    ...
                    <span class="pass-indicator text-small" v-if="allTestsPassed">
                        ✓ All tests passed!
                    </span>
                </div>
            </div>
            ...
            <div class="tests-list">
                <div v-for="(test, index) in testData.generated_output" :key="index"
                    :class="['test-item', getTestStatusClass(test)]" @click="runSingleTest(index)">
                    ...
                    <div class="test-details">
                        <div class="test-type">
                            <strong>Type:</strong> {{ test.check_type }}
                        </div>
...
const sampleTestData: TestData = {
    ...
    "generated_output": [
        ...
        },
        {
            "check_type": "logical",
            "expected": null,
            "result": "(ConceptModelValidationError(...), 'Concept local.agency is a root concept but has no datasources bound')",
            "ran": true,
            "query": ""
        }
    ],
