...
.editor-actions :deep(.contents) {
  display: inline-flex;
  align-items: center;
  gap: 0.3rem;
}
.editor-actions :deep(.action-item:hover) {
  background: var(--button-mouseover);
}
.editor-actions :deep(.action-item-scope) {
  padding: 0 10px;
  font-size: 11px;
  color: var(--text-faint);
}
.editor-actions :deep(.toggle-button) {
  border-radius: 999px;
}
.toggle-indicator {
  width: 6px;
...
.editor-actions :deep(.button-cancel) {
  background: var(--error-color);
  color: white;
  border-color: var(--error-color);
}
.editor-actions :deep(.button-run) {
  background: var(--special-text);
  color: white;
...
.editor-actions :deep(.button-cancel:hover) {
...
.editor-actions-mobile .action-group {
  gap: 6px;
  flex: 1 1 auto;
  min-width: 0;
}
.editor-actions-mobile .toolbar-divider {
  display: none;
}
...
.editor-actions-mobile :deep(.action-item-compact) {
  width: auto;
  min-width: 44px;
  padding: 0;
  gap: 0;
}
.editor-actions-mobile :deep(.action-item-compact .action-label) {
  display: none;
}
.editor-actions-mobile :deep(.action-item-scope) {
  width: auto;
  min-width: 64px;
  padding: 0 12px;
}
.editor-actions-mobile .action-group-execute {
  margin-left: auto;
  flex: 1.4 1 82px;
}
.editor-actions-mobile :deep(.action-group-execute .action-item) {
  width: 100%;
  min-width: 78px;
  padding: 0 14px;
}
.editor-actions-mobile :deep(.action-group-execute .action-label) {
  display: inline;
}
